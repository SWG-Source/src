...
bool ObjectsTableQuery::addData(const DB::Row *_data)
{
	...
	switch(mode)
	{
		...
		case mode_INSERT:
			...
			if (!m_node_xs.push_back(myData->node_x.isNull(), static_cast<int64_t>(myData->node_x.getValue()))) return false;
			if (!m_node_ys.push_back(myData->node_y.isNull(), static_cast<int64_t>(myData->node_y.getValue()))) return false;
			if (!m_node_zs.push_back(myData->node_z.isNull(), static_cast<int64_t>(myData->node_z.getValue()))) return false;
			if (!m_type_ids.push_back(myData->type_id.isNull(), static_cast<int64_t>(myData->type_id.getValue()))) return false;
			if (!m_scene_ids.push_back(myData->scene_id.getValueASCII())) return false;
			if (!m_controller_types.push_back(myData->controller_type.isNull(), static_cast<int64_t>(myData->controller_type.getValue()))) return false;
			if (!m_deleteds.push_back(myData->deleted.isNull(), static_cast<int64_t>(myData->deleted.getValue()))) return false;
			if (!m_object_names.push_back(myData->object_name.getValueASCII())) return false;
			if (!m_volumes.push_back(myData->volume.isNull(), static_cast<int64_t>(myData->volume.getValue()))) return false;
			if (!m_contained_bys.push_back(myData->contained_by.getValueASCII())) return false;
			if (!m_slot_arrangements.push_back(myData->slot_arrangement.isNull(), static_cast<int64_t>(myData->slot_arrangement.getValue()))) return false;
			if (!m_player_controlleds.push_back(myData->player_controlled.getValueASCII())) return false;
			if (!m_cache_versions.push_back(myData->cache_version.isNull(), static_cast<int64_t>(myData->cache_version.getValue()))) return false;
			if (!m_load_contentss.push_back(myData->load_contents.getValueASCII())) return false;
			if (!m_cash_balances.push_back(myData->cash_balance.isNull(), static_cast<int64_t>(myData->cash_balance.getValue()))) return false;
			if (!m_bank_balances.push_back(myData->bank_balance.isNull(), static_cast<int64_t>(myData->bank_balance.getValue()))) return false;
			...
			if (!m_static_item_versions.push_back(myData->static_item_version.isNull(), static_cast<int64_t>(myData->static_item_version.getValue()))) return false;
			if (!m_conversion_ids.push_back(myData->conversion_id.isNull(), static_cast<int64_t>(myData->conversion_id.getValue()))) return false;
			...
			if (!m_objvar_0_types.push_back(myData->objvar_0_type.isNull(), static_cast<int64_t>(myData->objvar_0_type.getValue()))) return false;
			...
			if (!m_objvar_1_types.push_back(myData->objvar_1_type.isNull(), static_cast<int64_t>(myData->objvar_1_type.getValue()))) return false;
			...
			if (!m_objvar_2_types.push_back(myData->objvar_2_type.isNull(), static_cast<int64_t>(myData->objvar_2_type.getValue()))) return false;
			...
			if (!m_objvar_3_types.push_back(myData->objvar_3_type.isNull(), static_cast<int64_t>(myData->objvar_3_type.getValue()))) return false;
			...
			if (!m_objvar_4_types.push_back(myData->objvar_4_type.isNull(), static_cast<int64_t>(myData->objvar_4_type.getValue()))) return false;
			...
			if (!m_objvar_5_types.push_back(myData->objvar_5_type.isNull(), static_cast<int64_t>(myData->objvar_5_type.getValue()))) return false;
			...
			if (!m_objvar_6_types.push_back(myData->objvar_6_type.isNull(), static_cast<int64_t>(myData->objvar_6_type.getValue()))) return false;
			...
			if (!m_objvar_7_types.push_back(myData->objvar_7_type.isNull(), static_cast<int64_t>(myData->objvar_7_type.getValue()))) return false;
			...
			if (!m_objvar_8_types.push_back(myData->objvar_8_type.isNull(), static_cast<int64_t>(myData->objvar_8_type.getValue()))) return false;
			...
			if (!m_objvar_9_types.push_back(myData->objvar_9_type.isNull(), static_cast<int64_t>(myData->objvar_9_type.getValue()))) return false;
			...
			if (!m_objvar_10_types.push_back(myData->objvar_10_type.isNull(), static_cast<int64_t>(myData->objvar_10_type.getValue()))) return false;
			...
			if (!m_objvar_11_types.push_back(myData->objvar_11_type.isNull(), static_cast<int64_t>(myData->objvar_11_type.getValue()))) return false;
			...
			if (!m_objvar_12_types.push_back(myData->objvar_12_type.isNull(), static_cast<int64_t>(myData->objvar_12_type.getValue()))) return false;
			...
			if (!m_objvar_13_types.push_back(myData->objvar_13_type.isNull(), static_cast<int64_t>(myData->objvar_13_type.getValue()))) return false;
			...
			if (!m_objvar_14_types.push_back(myData->objvar_14_type.isNull(), static_cast<int64_t>(myData->objvar_14_type.getValue()))) return false;
			...
			if (!m_objvar_15_types.push_back(myData->objvar_15_type.isNull(), static_cast<int64_t>(myData->objvar_15_type.getValue()))) return false;
			...
			if (!m_objvar_16_types.push_back(myData->objvar_16_type.isNull(), static_cast<int64_t>(myData->objvar_16_type.getValue()))) return false;
			...
			if (!m_objvar_17_types.push_back(myData->objvar_17_type.isNull(), static_cast<int64_t>(myData->objvar_17_type.getValue()))) return false;
			...
			if (!m_objvar_18_types.push_back(myData->objvar_18_type.isNull(), static_cast<int64_t>(myData->objvar_18_type.getValue()))) return false;
			...
			if (!m_objvar_19_types.push_back(myData->objvar_19_type.isNull(),static_cast<int64_t>( myData->objvar_19_type.getValue()))) return false;
