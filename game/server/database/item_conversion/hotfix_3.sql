CREATE OR REPLACE PACKAGE  "HOTFIX_3" as
...
CREATE OR REPLACE PACKAGE BODY  "HOTFIX_3" as
	-- private type defs
	...
	is
		...
		(-983864428, 1594162622, -1438161694, 2042493214, 1210744947, 1120303977)
		order by object_id;
	...
	begin
		...
		while objCursor%found loop
			begin
				...
				-- Do the conversions (-983864428, 1594162622, -1438161694, 2042493214, 1210744947)
   				if template_id = 1594162622 or template_id = -14381616948 or template_id = 2042493214 then
   					isObjModified := TRUE;
