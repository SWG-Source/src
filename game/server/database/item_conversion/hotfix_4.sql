CREATE OR REPLACE PACKAGE  "HOTFIX_4" as
...
CREATE OR REPLACE PACKAGE BODY  "HOTFIX_4" as
	-- private type defs
	...
	begin
		...
		while objCursor%found loop
			begin
				...
				if template_id = 1369190307 then
					AddObjVar('crafting_components.attackCost',2,'-3');
				--component/blaster_pistol_barrel_advanced
				elsif template_id = -1438464920 then
					AddObjVar('crafting_components.attackCost',2,'-6');
				...
				--component/scope_weapon
					...
					AddObjVar('crafting_components.accuracy',2,'8');
				--component/scope_weapon_advanced
				elsif template_id = -269033971 then
					AddObjVar('crafting_components.accuracy',2,'16');
				--component/stock
				elsif template_id = -651693115 then
					AddObjVar('crafting_components.attackCost',2,'-12');
				--component/stock_advanced
				elsif template_id = -1571384798 then
					AddObjVar('crafting_components.attackCost',2,'-20');
				...
				--component/vibro_unit_nightsister
					...
					AddObjVar('crafting_components.attackCost',2,'-7');
