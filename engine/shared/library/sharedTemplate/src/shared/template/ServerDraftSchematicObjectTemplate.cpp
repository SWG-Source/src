...
//@BEGIN TFD INIT
        : ServerIntangibleObjectTemplate(filename), m_slotsLoaded(false), m_slotsAppend(false),
          m_skillCommandsLoaded(false), m_skillCommandsAppend(false), m_manufactureScriptsLoaded(false),
...
ServerDraftSchematicObjectTemplate::getCompilerIntegerParam(const char *name, bool deepCheck, int index) {
...
ServerDraftSchematicObjectTemplate::getDynamicVariableParam(const char *name, bool deepCheck, int index) {
...
TriggerVolumeParam *
ServerDraftSchematicObjectTemplate::getTriggerVolumeParam(const char *name, bool deepCheck, int index) {
...
ServerDraftSchematicObjectTemplate::_IngredientSlot::_IngredientSlot(const std::string &filename)
        : TpfTemplate(filename), m_optionsLoaded(false), m_optionsAppend(false) {
...
CompilerIntegerParam *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getCompilerIntegerParam(const char *name, bool deepCheck,
                                                                             int index) {
...
FloatParam *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getFloatParam(const char *name, bool deepCheck, int index) {
...
BoolParam *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getBoolParam(const char *name, bool deepCheck, int index) {
...
StringParam *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getStringParam(const char *name, bool deepCheck, int index) {
    switch (runtimeCrc(name)) {
...
StringIdParam *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getStringIdParam(const char *name, bool deepCheck, int index) {
...
VectorParam *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getVectorParam(const char *name, bool deepCheck, int index) {
    return TpfTemplate::getVectorParam(name, deepCheck, index);
}    //ServerDraftSchematicObjectTemplate::_IngredientSlot::getVectorParam

DynamicVariableParam *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getDynamicVariableParam(const char *name, bool deepCheck,
                                                                             int index) {
...
StructParamOT *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getStructParamOT(const char *name, bool deepCheck, int index) {
...
TriggerVolumeParam *
ServerDraftSchematicObjectTemplate::_IngredientSlot::getTriggerVolumeParam(const char *name, bool deepCheck,
                                                                           int index) {
