...
//@BEGIN TFD INIT
        : TpfTemplate(filename), m_scriptsLoaded(false), m_scriptsAppend(false), m_visibleFlagsLoaded(false),
          m_visibleFlagsAppend(false), m_deleteFlagsLoaded(false), m_deleteFlagsAppend(false), m_moveFlagsLoaded(false),
          m_moveFlagsAppend(false), m_contentsLoaded(false), m_contentsAppend(false), m_xpPointsLoaded(false),
        ...
        switch (runtimeCrc(paramName)) {
            ...
            case constcrc("updateRanges"): {
                ...
                DEBUG_WARNING(listCount != 3,
                              ("Template %s: read array size of %d for array \"updateRanges\" of size 3, reading values anyway", file.getFileName(), listCount));
                int j;
...
ServerObjectTemplate::_AttribMod::getCompilerIntegerParam(const char *name, bool deepCheck, int index) {
    switch (runtimeCrc(name)) {
...
ServerObjectTemplate::_AttribMod::getDynamicVariableParam(const char *name, bool deepCheck, int index) {
    return TpfTemplate::getDynamicVariableParam(name, deepCheck, index);
...
TriggerVolumeParam *
ServerObjectTemplate::_AttribMod::getTriggerVolumeParam(const char *name, bool deepCheck, int index) {
    return TpfTemplate::getTriggerVolumeParam(name, deepCheck, index);
...
CompilerIntegerParam *
ServerObjectTemplate::_Contents::getCompilerIntegerParam(const char *name, bool deepCheck, int index) {
    return TpfTemplate::getCompilerIntegerParam(name, deepCheck, index);
...
DynamicVariableParam *
ServerObjectTemplate::_Contents::getDynamicVariableParam(const char *name, bool deepCheck, int index) {
    return TpfTemplate::getDynamicVariableParam(name, deepCheck, index);
...
TriggerVolumeParam *
ServerObjectTemplate::_Contents::getTriggerVolumeParam(const char *name, bool deepCheck, int index) {
    return TpfTemplate::getTriggerVolumeParam(name, deepCheck, index);
...
CompilerIntegerParam *
ServerObjectTemplate::_MentalStateMod::getCompilerIntegerParam(const char *name, bool deepCheck, int index) {
...
DynamicVariableParam *
ServerObjectTemplate::_MentalStateMod::getDynamicVariableParam(const char *name, bool deepCheck, int index) {
    return TpfTemplate::getDynamicVariableParam(name, deepCheck, index);
...
TriggerVolumeParam *
ServerObjectTemplate::_MentalStateMod::getTriggerVolumeParam(const char *name, bool deepCheck, int index) {
    return TpfTemplate::getTriggerVolumeParam(name, deepCheck, index);
