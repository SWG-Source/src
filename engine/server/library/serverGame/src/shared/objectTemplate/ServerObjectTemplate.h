...
private:
	...
	stdvector<IntegerParam *>::fwd m_visibleFlags;		// //who can see this object
	bool m_visibleFlagsLoaded;
	bool m_visibleFlagsAppend;
	stdvector<IntegerParam *>::fwd m_deleteFlags;		// //who can delete this object
	bool m_deleteFlagsLoaded;
	bool m_deleteFlagsAppend;
	stdvector<IntegerParam *>::fwd m_moveFlags;		// //who can move this object
